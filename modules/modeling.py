...
def build_model(model_name: str) -> Any:
    ...
    models = {
        ...
        "ElasticFace_Arc": ElasticFace.ElasticFace_ArcClient,
        "ElasticFace_Arc+": ElasticFace.ElasticFace_ArcplusClient,
        "ElasticFace_Cos": ElasticFace.ElasticFace_CosClient,
        "ElasticFace_Cos+": ElasticFace.ElasticFace_CosplusClient,
